...
<style  scoped>
	...
	#startDate{border:0;position: absolute;left: 0;margin: 0 auto;width: 50%;font-size: 16px;color: #05c0ad;text-align: center;height:20px;}
	#endDate{border:0;position: absolute;right: 0;margin:auto 0;width:50%;font-size: 16px;color: #05c0ad;text-align: center;height:20px;}
	.mask_calendar {
		width: 100%;
		height: 100%;
		position: fixed;
